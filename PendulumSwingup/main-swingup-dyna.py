...
parser.add_argument('--eval_steps', type=int, default=200, metavar='N',
...
env = gym.make('PendulumBB-v0')
env_test = gym.make('PendulumBB-v0')
env_sindy = gym.make('PendulumWB-v0', sindy_model=model)
env.seed(args.seed)
...
for iteration in range(num_runs):
    ...
    #np.save('../../SavedValues/Pendulum/Pendulum_SINDY_Updated_' + str(num_runs) + 'runs', temp)
env.close()
